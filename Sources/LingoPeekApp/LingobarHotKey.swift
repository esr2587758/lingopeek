...
struct LingobarHotKey: Equatable {
    var keyCode: UInt32
    var carbonModifiers: UInt32

    static let `default` = LingobarHotKey(
    ...
    var displayString: String {
        "\(Self.modifierDisplayString(carbonModifiers))\(Self.keyDisplayString(for: keyCode))"
    }

    var usesSingleKey: Bool {
        carbonModifiers == 0
    }
