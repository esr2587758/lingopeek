...
func checkLingobarHubShellSourceGate() throws {
    ...
    try check(viewSource.contains("HubHotKeyView(keys: state.hotKeyDisplayParts)"), "Hub settings should render hotkeys as keycaps")
    try check(viewSource.contains("private static func hotKeyParts"), "Hub settings should split hotkey display text into visible keycaps")
